...
- `project_ii_additional_gmm_member_orbital_followup.md` — Documents the Project
  II orbital follow-up of the 8 additional members of the Project V GMM reference
  component, including input provenance, Gaia DR3 uncertainty supplement,
  angular-momentum comparison, baseline `galpy` orbit metrics, basic Monte Carlo
  propagation, and the strengthened-partial-support interpretation.
